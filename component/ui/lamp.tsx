  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          <div className="absolute  w-fulleft-0 bg-slate-950 h-40 bottom-0 z-20 mask-[linear-gradient(to_top,white,transparent)]" />
        ...
        <div className="absolute inset-auto z-50 h-36 w-md -translate-y-80 sm:-translate-y-40 rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-80 sm:-translate-y-40 rounded-full   blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-120 -translate-y-80 rounded-full bg-cyan-400 "
        ></motion.div>

        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-60 bg-slate-950 "></div>
      </div>

      <div className="absolute text-center  -translate-y-60  flex sm:-translate-y-50    flex-col items-center ">
        {children}
      </div>
    </div>
  );
